import {
  AfterViewChecked, AfterViewInit, Component, ContentChildren, ElementRef, EventEmitter, Input, OnChanges, OnDestroy,
...
export class DragScrollComponent implements OnInit, OnDestroy, AfterViewInit, OnChanges, AfterViewChecked {
  private _index = 0;
